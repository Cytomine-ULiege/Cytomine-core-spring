...
public class ImageInstanceResourceTests {
    ...
    public void histograms() throws Exception {
        ...
        configureFor("localhost", 8888);
        System.out.println("/image/"+ URLEncoder.encode(image.getBaseImage().getPath(), StandardCharsets.UTF_8) +"/histogram/per-plane/z/0/t/0?n_bins=256&channels=0");
        stubFor(get(urlEqualTo("/image/"+ URLEncoder.encode(image.getBaseImage().getPath(), StandardCharsets.UTF_8) +"/histogram/per-image?n_bins=256"))
                .willReturn(
                        aResponse().withBody(
                                """
    ...
    public void histograms_bounds() throws Exception {
        ...
        stubFor(get(urlEqualTo("/image/"+ URLEncoder.encode(image.getBaseImage().getPath(), StandardCharsets.UTF_8) +"/histogram/per-image/bounds?n_bins=256"))
                .willReturn(
                        aResponse().withBody(
                                """
    ...
    public void channel_histograms() throws Exception {
        ...
        configureFor("localhost", 8888);
        System.out.println("/image/"+ URLEncoder.encode(image.getBaseImage().getPath(), StandardCharsets.UTF_8) +"/histogram/per-channels?n_bins=256");
        stubFor(get(urlEqualTo("/image/"+ URLEncoder.encode(image.getBaseImage().getPath(), StandardCharsets.UTF_8) +"/histogram/per-channels?n_bins=256"))
                .willReturn(
                        aResponse().withBody(
                                """
    ...
    public void channel_histograms_bounds() throws Exception {
        ...
        configureFor("localhost", 8888);
        stubFor(get(urlEqualTo("/image/"+ URLEncoder.encode(image.getBaseImage().getPath(), StandardCharsets.UTF_8) +"/histogram/per-channels/bounds"))
                .willReturn(
                        aResponse().withBody(
                                """
                                    {"items":[
